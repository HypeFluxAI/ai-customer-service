...
async function runLifecycle() {
    ...
    try {
        ...
        const staleResult = await KnowledgeBase.updateMany(
            ...
            { $set: { reviewStatus: 'flagged', updatedAt: new Date() } }
        );
        ...
        // 3. Auto-archive: flagged for 14+ days with no manual resolution
        ...
        console.log(`[KBLifecycle] done: flagged=${flagged}, archived=${archived}`);
    } catch (err) {
